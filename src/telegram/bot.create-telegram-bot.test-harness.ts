...
const { sessionStorePath } = vi.hoisted(() => ({
  sessionStorePath: `/tmp/fluffbuzz-telegram-${process.pid}-${process.env.VITEST_POOL_ID ?? "0"}.json`,
}));
...
const DEFAULT_TELEGRAM_TEST_CONFIG: FluffBuzzConfig = {
  agents: {
    defaults: {
