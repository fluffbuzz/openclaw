...
function registerAndResolveStatusHandler(cfg: FluffBuzzConfig): TelegramCommandHandler {
...
describe("registerTelegramNativeCommands — session metadata", () => {
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/fluffbuzz-sessions.json");
