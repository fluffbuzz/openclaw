...
const EMPTY_CFG = {} as FluffBuzzConfig;
...
async function applySubagentModelPatch(cfg: FluffBuzzConfig) {
...
function createAllowlistedAnthropicModelCfg(): FluffBuzzConfig {
  return {
    agents: {
      defaults: {
