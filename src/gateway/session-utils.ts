...
import { type FluffBuzzConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: FluffBuzzConfig): string[] {
...
export function listAgentsForGateway(cfg: FluffBuzzConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: FluffBuzzConfig): string {
...
function resolveSessionStoreAgentId(cfg: FluffBuzzConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: FluffBuzzConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: FluffBuzzConfig): GatewaySessionsDefaults {
