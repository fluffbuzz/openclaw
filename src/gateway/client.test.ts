...
function expectSecurityConnectError(
  ...
  expect(error.message).toContain("fluffbuzz doctor --fix");
...
describe("GatewayClient security checks", () => {
  const envSnapshot = captureEnv(["FLUFFBUZZ_ALLOW_INSECURE_PRIVATE_WS"]);
  ...
  it("allows ws:// to private addresses only with FLUFFBUZZ_ALLOW_INSECURE_PRIVATE_WS=1", () => {
