...
describe("loader", () => {
  ...
  beforeAll(async () => {
    fixtureRoot = await fs.mkdtemp(path.join(os.tmpdir(), "fluffbuzz-hooks-loader-"));
  });
  ...
  beforeEach(async () => {
    ...
    envSnapshot = captureEnv(["FLUFFBUZZ_BUNDLED_HOOKS_DIR"]);
    process.env.FLUFFBUZZ_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  });
  ...
  describe("loadInternalHooks", () => {
    ...
    const expectNoCommandHookRegistration = async (cfg: FluffBuzzConfig) => {
