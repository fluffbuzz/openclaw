/**
 * Hook system for FluffBuzz agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __fluffbuzz_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__fluffbuzz_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
