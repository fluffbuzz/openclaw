...
function resolveAnthropicDefaultAuthMode(cfg: FluffBuzzConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: FluffBuzzConfig): FluffBuzzConfig {
...
export function applyTalkApiKey(config: FluffBuzzConfig): FluffBuzzConfig {
...
export function applyTalkConfigNormalization(config: FluffBuzzConfig): FluffBuzzConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: FluffBuzzConfig): FluffBuzzConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: FluffBuzzConfig): FluffBuzzConfig {
...
export function applyLoggingDefaults(cfg: FluffBuzzConfig): FluffBuzzConfig {
...
export function applyContextPruningDefaults(cfg: FluffBuzzConfig): FluffBuzzConfig {
...
export function applyCompactionDefaults(cfg: FluffBuzzConfig): FluffBuzzConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
