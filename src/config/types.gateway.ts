...
export type WideAreaDiscoveryConfig = {
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "fluffbuzz.internal"). */
  domain?: string;
};
...
export type CanvasHostConfig = {
  enabled?: boolean;
  /** Directory to serve (default: ~/.fluffbuzz/workspace/canvas). */
  root?: string;
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/fluffbuzz"). */
  basePath?: string;
 ...
 * Used when Fluffbot runs behind an identity-aware proxy (Pomerium, Caddy + OAuth, etc.)
