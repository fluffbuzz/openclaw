...
export const A2UI_PATH = "/__fluffbuzz__/a2ui";

export const CANVAS_HOST_PATH = "/__fluffbuzz__/canvas";

export const CANVAS_WS_PATH = "/__fluffbuzz__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.fluffbuzzCanvasA2UIAction.postMessage(...)
  // - Android: window.fluffbuzzCanvasA2UIAction.postMessage(...)
  const handlerNames = ["fluffbuzzCanvasA2UIAction"];
  ...
  globalThis.FluffBuzz = globalThis.FluffBuzz ?? {};
  globalThis.FluffBuzz.postMessage = postToNode;
  globalThis.FluffBuzz.sendUserAction = sendUserAction;
  globalThis.fluffbuzzPostMessage = postToNode;
  globalThis.fluffbuzzSendUserAction = sendUserAction;
