...
import {
  probeAuthenticatedFluffBuzzRelay,
...
describe("extension-relay-auth", () => {
  ...
  it("accepts authenticated fluffbuzz relay probe responses", async () => {
    ...
    await withRelayServer(
      ...
      async ({ port }) => {
        ...
        const ok = await probeAuthenticatedFluffBuzzRelay({
          baseUrl: `http://127.0.0.1:${port}`,
          relayAuthHeader: "x-fluffbuzz-relay-token",
