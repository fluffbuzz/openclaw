...
export function listWhatsAppAuthDirs(cfg: FluffBuzzConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: FluffBuzzConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: FluffBuzzConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: FluffBuzzConfig): ResolvedWhatsAppAccount[] {
