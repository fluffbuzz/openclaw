...
function resolveAdaptiveReadMaxBytes(options?: FluffBuzzReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createFluffBuzzReadTool(base, {
...
export function createFluffBuzzReadTool(
  base: AnyAgentTool,
  options?: FluffBuzzReadToolOptions,
): AnyAgentTool {
