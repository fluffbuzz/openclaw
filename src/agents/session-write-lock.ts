...
const CLEANUP_STATE_KEY = Symbol.for("fluffbuzz.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("fluffbuzz.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("fluffbuzz.sessionWriteLockWatchdogState");
