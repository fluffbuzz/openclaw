...
function resolveAvatarSource(cfg: FluffBuzzConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: FluffBuzzConfig, agentId: string): AgentAvatarResolution {
