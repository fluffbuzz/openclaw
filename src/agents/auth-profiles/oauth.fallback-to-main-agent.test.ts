...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveFluffBuzzAgentDir() returns mainAgentDir
    process.env.FLUFFBUZZ_STATE_DIR = tmpDir;
    process.env.FLUFFBUZZ_AGENT_DIR = mainAgentDir;
