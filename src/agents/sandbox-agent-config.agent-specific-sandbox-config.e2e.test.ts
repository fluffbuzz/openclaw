...
async function resolveContext(config: FluffBuzzConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): FluffBuzzConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
