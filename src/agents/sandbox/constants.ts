...
export const DEFAULT_SANDBOX_IMAGE = "fluffbuzz-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "fluffbuzz-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "fluffbuzz-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "fluffbuzz-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "fluffbuzz-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "fluffbuzz-sandbox-browser";
