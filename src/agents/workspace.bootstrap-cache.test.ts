...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    workspaceDir = await makeTempWorkspace("fluffbuzz-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("fluffbuzz-cache-test1-");
    const workspace2 = await makeTempWorkspace("fluffbuzz-cache-test2-");
