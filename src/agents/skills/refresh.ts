...
function resolveWatchPaths(workspaceDir: string, config?: FluffBuzzConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: FluffBuzzConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: FluffBuzzConfig }) {
