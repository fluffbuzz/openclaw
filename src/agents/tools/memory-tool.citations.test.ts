...
function asFluffBuzzConfig(config: Partial<FluffBuzzConfig>): FluffBuzzConfig {
  return config as FluffBuzzConfig;
}

function createToolConfig() {
  return asFluffBuzzConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: FluffBuzzConfig = createToolConfig()) {
