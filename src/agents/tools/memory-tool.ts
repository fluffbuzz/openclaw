...
function resolveMemoryToolContext(options: { config?: FluffBuzzConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: FluffBuzzConfig): MemoryCitationsMode {
