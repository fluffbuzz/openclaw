...
function resolveDefaultModelRef(cfg?: FluffBuzzConfig): {
  provider: string;
  model: string;
} {
  if (cfg) {
...
function pickMaxBytes(cfg?: FluffBuzzConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  const effectiveCfg: FluffBuzzConfig | undefined = params.cfg
    ? {
        ...params.cfg,
        agents: {
          ...params.cfg.agents,
  ...
  await ensureFluffBuzzModelsJson(effectiveCfg, params.agentDir);
