...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): FluffBuzzConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: FluffBuzzConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: FluffBuzzConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
