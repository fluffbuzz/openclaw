...
import { resolveFluffBuzzDocsPath } from "../../docs-path.js";
...
import { createFluffBuzzCodingTools, resolveToolLoopDetectionConfig } from "../../pi-tools.js";
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const agentDir = params.agentDir ?? resolveFluffBuzzAgentDir();
    ...
    const docsPath = await resolveFluffBuzzDocsPath({
      workspaceDir: effectiveWorkspace,
    ...
    try {
      ...
      try {
        ...
        // double-compaction. See: https://github.com/fluffbuzz/fluffbuzz/issues/9282
        ...
        if (promptError && promptErrorSource === "prompt" && !compactionOccurredThisAttempt) {
          try {
            sessionManager.appendCustomEntry("fluffbuzz:prompt-error", {
              timestamp: Date.now(),
              runId: params.runId,
              sessionId: params.sessionId,
              provider: params.provider,
      ...
      // See: https://github.com/fluffbuzz/fluffbuzz/issues/8643
