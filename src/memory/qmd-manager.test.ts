...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: FluffBuzzConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: FluffBuzzConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__fluffbuzzMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__fluffbuzzMcporterColdStartWarned;
  });
