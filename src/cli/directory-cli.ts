    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["fluffbuzz directory self --channel slack", "Show the connected account identity."],
          [
            'fluffbuzz directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["fluffbuzz directory groups list --channel discord", "List available groups/channels."],
          [
            "fluffbuzz directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.fluffbuzz.com/cli/directory",
        )}\n`,
    )
    .action(() => {
