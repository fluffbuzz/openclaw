    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["fluffbuzz channels list", "List configured channels and auth profiles."],
          ["fluffbuzz channels status --probe", "Run channel status checks and probes."],
          [
            "fluffbuzz channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["fluffbuzz channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.fluffbuzz.com/cli/channels",
        )}\n`,
    );
