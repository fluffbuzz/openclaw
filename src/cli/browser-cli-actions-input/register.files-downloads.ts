...
export function registerBrowserFilesAndDownloadsCommands(
  ...
  browser
    ...
    .argument(
      "<paths...>",
      "File paths to upload (must be within FluffBuzz temp uploads dir, e.g. /tmp/fluffbuzz/uploads/file.pdf)",
    )
  ...
  browser
    ...
    .argument(
      "[path]",
      "Save path within fluffbuzz temp downloads dir (default: /tmp/fluffbuzz/downloads/...; fallback: os.tmpdir()/fluffbuzz/downloads/...)",
    )
    .option("--target-id <id>", "CDP target id (or unique prefix)")
    .option(
      "--timeout-ms <ms>",
  ...
  browser
    ...
    .argument(
      "<path>",
      "Save path within fluffbuzz temp downloads dir (e.g. report.pdf or /tmp/fluffbuzz/downloads/report.pdf)",
    )
    .option("--target-id <id>", "CDP target id (or unique prefix)")
    .option(
      "--timeout-ms <ms>",
