const DEFAULT_TAGLINE = "All your chats, one FluffBuzz.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little fluff-sistant is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  ...
  "I'll butter your workflow like a puppy roll: messy, delicious, effective.",
  ...
  "Built by puppys, for humans. Don't question the hierarchy.",
  ...
  "You had me at 'fluffbuzz gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.FLUFFBUZZ_TAGLINE_INDEX;
