...
describe("registerPreActionHooks", () => {
  ...
  it("applies --json stdout suppression only for explicit JSON output commands", async () => {
    await runPreAction({
      ...
      processArgv: ["node", "fluffbuzz", "update", "status", "--json"],
    });
    ...
    await runPreAction({
      ...
      processArgv: ["node", "fluffbuzz", "config", "set", "gateway.auth.mode", "{bad", "--json"],
    });
  ...
  it("bypasses config guard for config validate", async () => {
    await runPreAction({
      ...
      processArgv: ["node", "fluffbuzz", "config", "validate"],
    });
  ...
  it("bypasses config guard for config validate when root option values are present", async () => {
    await runPreAction({
      parseArgv: ["config", "validate"],
      processArgv: ["node", "fluffbuzz", "--profile", "work", "config", "validate"],
    });
