...
const shouldRegisterPrimaryOnly = (argv: string[]) => {
  if (isTruthyEnvValue(process.env.FLUFFBUZZ_DISABLE_LAZY_SUBCOMMANDS)) {
    return false;
  }
...
const shouldEagerRegisterSubcommands = (_argv: string[]) => {
  return isTruthyEnvValue(process.env.FLUFFBUZZ_DISABLE_LAZY_SUBCOMMANDS);
};

const loadConfig = async (): Promise<FluffBuzzConfig> => {
...
const entries: SubCliEntry[] = [
  ...
  {
    name: "docs",
    description: "Search the live FluffBuzz docs",
    hasSubcommands: false,
    register: async (program) => {
  ...
  {
    name: "plugins",
    description: "Manage FluffBuzz plugins and extensions",
    hasSubcommands: true,
    register: async (program) => {
