      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["fluffbuzz gateway run", "Run the gateway in the foreground."],
            ["fluffbuzz gateway status", "Show service status and probe reachability."],
            ["fluffbuzz gateway discover", "Find local and wide-area gateway beacons."],
            ["fluffbuzz gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.fluffbuzz.com/cli/gateway")}\n`,
      ),
  );
