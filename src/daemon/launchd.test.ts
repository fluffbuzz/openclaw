...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 com.fluffbuzz.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", FLUFFBUZZ_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "com.fluffbuzz.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.fluffbuzz.com/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when FLUFFBUZZ_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/com.fluffbuzz.gateway.plist",
    },
    {
      name: "uses profile-specific label when FLUFFBUZZ_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", FLUFFBUZZ_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/com.fluffbuzz.jbphoenix.plist",
    },
    {
      name: "prefers FLUFFBUZZ_LAUNCHD_LABEL over FLUFFBUZZ_PROFILE",
      env: {
        HOME: "/Users/test",
        FLUFFBUZZ_PROFILE: "jbphoenix",
        FLUFFBUZZ_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from FLUFFBUZZ_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        FLUFFBUZZ_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty FLUFFBUZZ_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        FLUFFBUZZ_PROFILE: "myprofile",
        FLUFFBUZZ_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/com.fluffbuzz.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
