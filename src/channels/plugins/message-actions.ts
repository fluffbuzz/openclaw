...
export function listChannelMessageActions(cfg: FluffBuzzConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: FluffBuzzConfig): boolean {
...
export function supportsChannelMessageCards(cfg: FluffBuzzConfig): boolean {
