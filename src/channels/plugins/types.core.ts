...
export type ChannelAgentToolFactory = (params: { cfg?: FluffBuzzConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: FluffBuzzConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: FluffBuzzConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: FluffBuzzConfig }) => boolean;
  supportsCards?: (params: { cfg: FluffBuzzConfig }) => boolean;
