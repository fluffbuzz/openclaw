...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: FluffBuzzConfig, accountId?: string | null) => ResolvedAccount;
  defaultAccountId?: (cfg: FluffBuzzConfig) => string;
  setAccountEnabled?: (params: {
    cfg: FluffBuzzConfig;
    accountId: string;
    enabled: boolean;
  }) => FluffBuzzConfig;
  deleteAccount?: (params: { cfg: FluffBuzzConfig; accountId: string }) => FluffBuzzConfig;
  isEnabled?: (account: ResolvedAccount, cfg: FluffBuzzConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: FluffBuzzConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: FluffBuzzConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: FluffBuzzConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: FluffBuzzConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.fluffbuzz.com/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: FluffBuzzConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
