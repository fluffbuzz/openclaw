...
export function createAccountListHelpers(channelKey: string) {
  function resolveConfiguredDefaultAccountId(cfg: FluffBuzzConfig): string | undefined {
  ...
  function listAccountIds(cfg: FluffBuzzConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: FluffBuzzConfig): string {
