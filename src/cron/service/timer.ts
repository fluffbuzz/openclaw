...
export async function onTimer(state: CronServiceState) {
  if (state.running) {
    ...
    // execution to finish.
    // See: https://github.com/fluffbuzz/fluffbuzz/issues/12025
...
> {
    ...
    if (job.wakeMode === "now" && state.deps.runHeartbeatOnce) {
      ...
      for (;;) {
        ...
        heartbeatResult = await state.deps.runHeartbeatOnce({
          ...
          // See: https://github.com/fluffbuzz/fluffbuzz/issues/28508
  ...
  // See: https://github.com/fluffbuzz/fluffbuzz/issues/15692
  //
  ...
  // See: https://github.com/fluffbuzz/fluffbuzz/issues/32013
