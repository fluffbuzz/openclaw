...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.fluffbuzz.com/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("fluffbuzz hooks list")}`,
      `  ${formatCliCommand("fluffbuzz hooks enable <name>")}`,
      `  ${formatCliCommand("fluffbuzz hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
