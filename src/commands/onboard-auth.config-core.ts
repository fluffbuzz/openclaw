...
export function applyOpenrouterProviderConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: FluffBuzzConfig): FluffBuzzConfig {
...
export function applyMoonshotConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: FluffBuzzConfig): FluffBuzzConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
...
export function applyQianfanProviderConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: FluffBuzzConfig): FluffBuzzConfig {
