...
function resolveResolutionLimits(config: FluffBuzzConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: FluffBuzzConfig): SecretProviderConfig {
