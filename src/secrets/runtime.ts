...
type SecretDefaults = NonNullable<FluffBuzzConfig["secrets"]>["defaults"];
...
function collectCandidateAgentDirs(config: FluffBuzzConfig): string[] {
  const dirs = new Set<string>();
  dirs.add(resolveUserPath(resolveFluffBuzzAgentDir()));
