...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof FluffBuzzConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: FluffBuzzConfig; env: NodeJS.ProcessEnv }): {
  cfg: FluffBuzzConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
