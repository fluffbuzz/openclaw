...
function mergeDiscordAccountConfig(cfg: FluffBuzzConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: FluffBuzzConfig): ResolvedDiscordAccount[] {
