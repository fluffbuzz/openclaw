...
export function isAcpEnabledByPolicy(cfg: FluffBuzzConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: FluffBuzzConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: FluffBuzzConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: FluffBuzzConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: FluffBuzzConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: FluffBuzzConfig, agentId: string): boolean {
