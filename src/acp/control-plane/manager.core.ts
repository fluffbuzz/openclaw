...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: FluffBuzzConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: FluffBuzzConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: FluffBuzzConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: FluffBuzzConfig }): Promise<void> {
