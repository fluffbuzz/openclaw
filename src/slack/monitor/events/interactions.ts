...
// Prefix for FluffBuzz-generated action IDs to scope our handler
const FLUFFBUZZ_ACTION_PREFIX = "fluffbuzz:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${FLUFFBUZZ_ACTION_PREFIX}`);

  // Handle FluffBuzz modal submissions with callback_ids scoped by our prefix.
