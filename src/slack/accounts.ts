...
function mergeSlackAccountConfig(cfg: FluffBuzzConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: FluffBuzzConfig): ResolvedSlackAccount[] {
