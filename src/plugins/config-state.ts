...
export const normalizePluginsConfig = (
  config?: FluffBuzzConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: FluffBuzzConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: FluffBuzzConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: FluffBuzzConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
