...
export const PLUGIN_MANIFEST_FILENAME = "fluffbuzz.plugin.json";
...
// package.json "fluffbuzz" metadata (used for onboarding/catalog)
...
export type FluffBuzzPackageManifest = {
  extensions?: string[];
...
): FluffBuzzPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
