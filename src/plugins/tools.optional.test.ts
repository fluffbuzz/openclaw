...
const loadFluffBuzzPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadFluffBuzzPlugins: (params: unknown) => loadFluffBuzzPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadFluffBuzzPluginsMock.mockReturnValue(registry);
  return registry;
}
...
describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadFluffBuzzPluginsMock.mockClear();
  });
