...
export type FluffBuzzPluginConfigSchema = {
...
export type FluffBuzzPluginToolContext = {
...
export type FluffBuzzPluginToolFactory = (
  ctx: FluffBuzzPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type FluffBuzzPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type FluffBuzzPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<FluffBuzzConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type FluffBuzzPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current FluffBuzz configuration */
  config: FluffBuzzConfig;
 ...
 */
export type FluffBuzzPluginCommandDefinition = {
...
export type FluffBuzzPluginHttpRouteAuth = "gateway" | "plugin";
export type FluffBuzzPluginHttpRouteMatch = "exact" | "prefix";

export type FluffBuzzPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean | void> | boolean | void;

export type FluffBuzzPluginHttpRouteParams = {
  path: string;
  handler: FluffBuzzPluginHttpRouteHandler;
  auth: FluffBuzzPluginHttpRouteAuth;
  match?: FluffBuzzPluginHttpRouteMatch;
  replaceExisting?: boolean;
};

export type FluffBuzzPluginCliContext = {
  program: Command;
  config: FluffBuzzConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type FluffBuzzPluginCliRegistrar = (ctx: FluffBuzzPluginCliContext) => void | Promise<void>;

export type FluffBuzzPluginServiceContext = {
  config: FluffBuzzConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type FluffBuzzPluginService = {
  id: string;
  start: (ctx: FluffBuzzPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: FluffBuzzPluginServiceContext) => void | Promise<void>;
};

export type FluffBuzzPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type FluffBuzzPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: FluffBuzzPluginConfigSchema;
  register?: (api: FluffBuzzPluginApi) => void | Promise<void>;
  activate?: (api: FluffBuzzPluginApi) => void | Promise<void>;
};

export type FluffBuzzPluginModule =
  | FluffBuzzPluginDefinition
  | ((api: FluffBuzzPluginApi) => void | Promise<void>);

export type FluffBuzzPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | FluffBuzzPluginToolFactory,
    opts?: FluffBuzzPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: FluffBuzzPluginHookOptions,
  ) => void;
  registerHttpRoute: (params: FluffBuzzPluginHttpRouteParams) => void;
  registerChannel: (registration: FluffBuzzPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: FluffBuzzPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: FluffBuzzPluginService) => void;
   ...
   */
  registerCommand: (command: FluffBuzzPluginCommandDefinition) => void;
