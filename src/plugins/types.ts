...
export type FluffBuzzPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
...
export type FluffBuzzPluginApi = {
  ...
  registerHttpHandler: (handler: FluffBuzzPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: FluffBuzzPluginHttpRouteHandler }) => void;
