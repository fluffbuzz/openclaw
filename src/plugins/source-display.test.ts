...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/fluffbuzz/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/fluffbuzz/extensions",
        global: "/Users/x/.fluffbuzz/extensions",
        workspace: "/Users/x/ws/.fluffbuzz/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.fluffbuzz/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/fluffbuzz/extensions",
        global: "/Users/x/.fluffbuzz/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.fluffbuzz/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/fluffbuzz/extensions",
        global: "/Users/x/.fluffbuzz/extensions",
