...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.FLUFFBUZZ_TTS_PREFS;
      process.env.FLUFFBUZZ_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.FLUFFBUZZ_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: FluffBuzzConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
