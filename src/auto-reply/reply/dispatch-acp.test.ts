...
const policyMocks = vi.hoisted(() => ({
  resolveAcpDispatchPolicyError: vi.fn<(cfg: FluffBuzzConfig) => AcpRuntimeError | null>(() => null),
  resolveAcpAgentPolicyError: vi.fn<(cfg: FluffBuzzConfig, agent: string) => AcpRuntimeError | null>(
    () => null,
  ),
}));
...
const ttsMocks = vi.hoisted(() => ({
  ...
  resolveTtsConfig: vi.fn((_cfg: FluffBuzzConfig) => ({ mode: "final" })),
}));

const sessionMetaMocks = vi.hoisted(() => ({
  readAcpSessionEntry: vi.fn<
    (params: { sessionKey: string; cfg?: FluffBuzzConfig }) => AcpSessionStoreEntry | null
  >(() => null),
}));
...
vi.mock("../../acp/policy.js", () => ({
  resolveAcpDispatchPolicyError: (cfg: FluffBuzzConfig) =>
    policyMocks.resolveAcpDispatchPolicyError(cfg),
  resolveAcpAgentPolicyError: (cfg: FluffBuzzConfig, agent: string) =>
...
vi.mock("../../tts/tts.js", () => ({
  ...
  resolveTtsConfig: (cfg: FluffBuzzConfig) => ttsMocks.resolveTtsConfig(cfg),
}));

vi.mock("../../acp/runtime/session-meta.js", () => ({
  readAcpSessionEntry: (params: { sessionKey: string; cfg?: FluffBuzzConfig }) =>
...
function createAcpConfigWithVisibleToolTags(): FluffBuzzConfig {
