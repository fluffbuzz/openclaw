...
function resolveAcpStreamCoalesceIdleMs(cfg: FluffBuzzConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: FluffBuzzConfig): number {
...
export function resolveAcpProjectionSettings(cfg: FluffBuzzConfig): AcpProjectionSettings {
