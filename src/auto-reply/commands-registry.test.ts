...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@fluffbuzz", { botUsername: "fluffbuzz" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@fluffbuzz args", {
        botUsername: "fluffbuzz",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@fluffbuzz: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "fluffbuzz" })).toBe(
      "/help@otherbot",
    );
  });
