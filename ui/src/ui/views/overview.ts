...
export function renderOverview(props: OverviewProps) {
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <span class="mono">fluffbuzz devices list</span><br />
          <span class="mono">fluffbuzz devices approve &lt;requestId&gt;</span>
        </div>
        ...
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.fluffbuzz.com/web/control-ui#device-pairing-first-connection"
  ...
  const authHint = (() => {
    ...
    if (isAuthRequired) {
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">fluffbuzz dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">fluffbuzz doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
              href="https://docs.fluffbuzz.com/web/dashboard"
              target=${EXTERNAL_LINK_TARGET}
              rel=${buildExternalLinkRel()}
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ${t("overview.auth.failed", { command: "fluffbuzz dashboard --no-open" })}
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.fluffbuzz.com/web/dashboard"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.fluffbuzz.com/gateway/tailscale"
            target=${EXTERNAL_LINK_TARGET}
            rel=${buildExternalLinkRel()}
          ...
          <a
            class="session-link"
            href="https://docs.fluffbuzz.com/web/control-ui#insecure-http"
            target=${EXTERNAL_LINK_TARGET}
            rel=${buildExternalLinkRel()}
              ...
              : html`
                <label class="field">
                  ...
                  <input
                    ...
                    placeholder="FLUFFBUZZ_GATEWAY_TOKEN"
                  />
                </label>
                <label class="field">
