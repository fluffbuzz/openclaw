...
import { FluffBuzzApp } from "./app.ts";
...
function resetChatStateForSessionSwitch(state: AppViewState, sessionKey: string) {
  ...
  (state as unknown as FluffBuzzApp).chatStreamStartedAt = null;
  state.chatRunId = null;
  (state as unknown as FluffBuzzApp).resetToolStream();
  (state as unknown as FluffBuzzApp).resetChatScroll();
  state.applySettings({
    ...state.settings,
    sessionKey,
  ...
  return html`
    <div class="chat-controls">
      ...
      <button
        ...
        @click=${async () => {
          const app = state as unknown as FluffBuzzApp;
