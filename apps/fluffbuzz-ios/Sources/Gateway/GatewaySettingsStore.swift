...
enum GatewaySettingsStore {
    private static let gatewayService = "com.fluffbuzz.gateway"
    private static let nodeService = "com.fluffbuzz.node"
    private static let talkService = "com.fluffbuzz.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "com.fluffbuzz.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "com.fluffbuzz.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("fluffbuzz-gateway.log")
    }
