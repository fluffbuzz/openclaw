...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: FluffBuzzPhotosLatestParams) async throws -> FluffBuzzPhotosLatestPayload {
        ...
        var results: [FluffBuzzPhotoPayload] = []
        ...
        return FluffBuzzPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> FluffBuzzPhotoPayload
    {
