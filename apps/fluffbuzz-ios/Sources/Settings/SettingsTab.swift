...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = FluffBuzzLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = FluffBuzzLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "com.fluffbuzz.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected FluffBuzz agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips "
                                + "while FluffBuzz is foregrounded."
                        )
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for FluffBuzz. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(FluffBuzzLocationMode.off.rawValue)
                            Text("While Using").tag(FluffBuzzLocationMode.whileUsing.rawValue)
                            Text("Always").tag(FluffBuzzLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while FluffBuzz is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("FluffBuzz", value: DeviceInfoHelper.openClawVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = FluffBuzzLocationMode(rawValue: newValue) else { return }
                Task {
