...
enum WatchMessagingError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .watchAppNotInstalled:
            "WATCH_UNAVAILABLE: FluffBuzz watch companion app is not installed"
        }
    }
}

final class WatchMessagingService: NSObject, WatchMessagingServicing, @unchecked Sendable {
    private static let logger = Logger(subsystem: "com.fluffbuzz", category: "watch.messaging")
        ...
        params: FluffBuzzWatchNotifyParams) async throws -> WatchNotificationSendResult
    {
        ...
        var payload: [String: Any] = [
            ...
            "title": params.title,
            "body": params.body,
            "priority": params.priority?.rawValue ?? FluffBuzzNotificationPriority.active.rawValue,
