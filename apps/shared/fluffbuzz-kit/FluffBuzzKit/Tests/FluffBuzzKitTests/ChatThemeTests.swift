...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = FluffBuzzChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = FluffBuzzChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
