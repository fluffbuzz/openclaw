...
@MainActor
public struct FluffBuzzChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: FluffBuzzChatViewModel
    ...
    public init(
        viewModel: FluffBuzzChatViewModel,
    ...
    private var visibleMessages: [FluffBuzzChatMessage] {
        let base: [FluffBuzzChatMessage]
    ...
    private func mergeToolResults(in messages: [FluffBuzzChatMessage]) -> [FluffBuzzChatMessage] {
        ...
        for message in messages {
            ...
            let merged = FluffBuzzChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: FluffBuzzChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: FluffBuzzChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: FluffBuzzChatMessage) -> String {
