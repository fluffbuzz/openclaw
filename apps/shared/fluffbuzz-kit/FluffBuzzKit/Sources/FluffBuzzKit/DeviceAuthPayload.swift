...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: FluffBuzzProtocol.AnyCodable]?
    {
        ...
        return [
            "id": FluffBuzzProtocol.AnyCodable(identity.deviceId),
            "publicKey": FluffBuzzProtocol.AnyCodable(publicKey),
            "signature": FluffBuzzProtocol.AnyCodable(signature),
            "signedAt": FluffBuzzProtocol.AnyCodable(signedAtMs),
            "nonce": FluffBuzzProtocol.AnyCodable(nonce),
        ]
    }
}
