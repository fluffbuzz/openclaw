...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "com.fluffbuzz", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "com.fluffbuzz", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: FluffBuzzProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
