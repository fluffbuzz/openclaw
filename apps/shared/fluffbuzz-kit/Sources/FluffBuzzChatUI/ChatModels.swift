...
public typealias FluffBuzzPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias FluffBuzzPlatformImage = UIImage
#endif

public struct FluffBuzzChatUsageCost: Codable, Hashable, Sendable {
...
public struct FluffBuzzChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: FluffBuzzChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(FluffBuzzChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct FluffBuzzChatMessageContent: Codable, Hashable, Sendable {
...
public struct FluffBuzzChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [FluffBuzzChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: FluffBuzzChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [FluffBuzzChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: FluffBuzzChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(FluffBuzzChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([FluffBuzzChatMessageContent].self, forKey: .content) {
...
public struct FluffBuzzChatHistoryPayload: Codable, Sendable {
...
public struct FluffBuzzSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct FluffBuzzSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [FluffBuzzSessionPreviewItem]
}

public struct FluffBuzzSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [FluffBuzzSessionPreviewEntry]

    public init(ts: Int, previews: [FluffBuzzSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct FluffBuzzChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct FluffBuzzChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct FluffBuzzAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct FluffBuzzChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct FluffBuzzGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct FluffBuzzPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: FluffBuzzPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: FluffBuzzPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct FluffBuzzChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
