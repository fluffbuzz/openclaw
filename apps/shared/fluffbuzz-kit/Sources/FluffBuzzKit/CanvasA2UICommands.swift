...
public enum FluffBuzzCanvasA2UICommand: String, Codable, Sendable {
...
public struct FluffBuzzCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct FluffBuzzCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
