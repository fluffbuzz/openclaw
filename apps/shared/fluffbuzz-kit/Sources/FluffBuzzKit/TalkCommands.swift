...
public enum FluffBuzzTalkCommand: String, Codable, Sendable {
...
public struct FluffBuzzTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct FluffBuzzTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
