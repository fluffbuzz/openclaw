...
class SecurePrefs(context: Context) {
  companion object {
    val defaultWakeWords: List<String> = listOf("fluffbuzz", "claude")
    private const val displayNameKey = "node.displayName"
    private const val voiceWakeModeKey = "voiceWake.mode"
    private const val plainPrefsName = "fluffbuzz.node"
    private const val securePrefsName = "fluffbuzz.node.secure"
  }
