...
android {
    namespace = "com.fluffbuzz.android"
    compileSdk = 36

    sourceSets {
        getByName("main") {
            assets.directories.add("../../shared/FluffBuzzKit/Sources/FluffBuzzKit/Resources")
        }
    }

    defaultConfig {
        applicationId = "com.fluffbuzz.android"
        minSdk = 31
        targetSdk = 36
    ...
    onVariants { variant ->
        variant.outputs
            ...
            .forEach { output ->
                ...
                val outputFileName = "fluffbuzz-$versionName-$buildType.apk"
