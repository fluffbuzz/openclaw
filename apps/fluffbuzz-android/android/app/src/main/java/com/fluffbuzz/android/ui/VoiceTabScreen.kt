...
import com.fluffbuzz.android.voice.VoiceConversationRole
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("FluffBuzz is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
