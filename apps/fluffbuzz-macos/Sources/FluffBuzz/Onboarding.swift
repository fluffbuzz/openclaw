...
enum UIStrings {
    static let welcomeTitle = "Welcome to FluffBuzz"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "fluffbuzz.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: FluffBuzzChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g fluffbuzz@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: FluffBuzzChatViewModel(
