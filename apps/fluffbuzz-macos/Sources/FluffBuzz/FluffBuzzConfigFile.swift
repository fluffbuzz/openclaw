...
enum FluffBuzzConfigFile {
    private static let logger = Logger(subsystem: "com.fluffbuzz", category: "config")
    ...
    static func stateDirURL() -> URL {
        FluffBuzzPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        FluffBuzzPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-fluffbuzz-config-file",
            "event": "config.write",
