...
@Suite(.serialized) struct CommandResolverTests {
    ...
    @Test func prefersFluffBuzzBinary() throws {
        ...
        try makeExecutableForTests(at: fluffbuzzPath)
    ...
    @Test func prefersFluffBuzzBinaryOverPnpm() throws {
        let defaults = self.makeLocalDefaults()
    ...
    @Test func usesFluffBuzzBinaryWithoutNodeRuntime() throws {
        let defaults = self.makeLocalDefaults()
