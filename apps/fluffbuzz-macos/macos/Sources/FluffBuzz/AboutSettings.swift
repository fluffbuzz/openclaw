...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/fluffbuzz/fluffbuzz") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/fluffbuzz/fluffbuzz")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://fluffbuzz.com")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "FluffBuzzBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "FluffBuzzBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "FluffBuzzGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "FluffBuzzGitCommit") as? String) ??
            "unknown"
    }
