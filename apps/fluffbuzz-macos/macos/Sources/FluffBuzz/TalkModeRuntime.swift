...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "com.fluffbuzz", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "com.fluffbuzz", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [FluffBuzzChatMessage] = messages.compactMap { item in
