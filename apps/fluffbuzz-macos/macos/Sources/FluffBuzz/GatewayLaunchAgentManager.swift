...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "com.fluffbuzz", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".fluffbuzz/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.fluffbuzzCommand(
            subcommand: "gateway",
