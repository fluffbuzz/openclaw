...
actor RemoteTunnelManager {
    ...
    private let logger = Logger(subsystem: "com.fluffbuzz", category: "remote-tunnel")
    ...
    func controlTunnelPortIfRunning() async -> UInt16? {
        ...
        // If a previous FluffBuzz run already has an SSH listener on the expected port (common after restarts),
