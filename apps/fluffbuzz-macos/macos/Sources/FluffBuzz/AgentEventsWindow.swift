...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: FluffBuzzProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": FluffBuzzProtocol.AnyCodable("start"),
                "name": FluffBuzzProtocol.AnyCodable("bash"),
            ],
            summary: nil)
