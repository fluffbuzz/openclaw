...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "com.fluffbuzz", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return FluffBuzzConfigFile.defaultWorkspaceURL() }
