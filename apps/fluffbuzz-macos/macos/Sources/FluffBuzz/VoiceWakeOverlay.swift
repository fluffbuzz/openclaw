...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "com.fluffbuzz", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other FluffBuzz windows, but below the system’s pop-up menus.
