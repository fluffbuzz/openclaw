...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .fluffbuzzSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? FluffBuzzPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? FluffBuzzPaths.stateDirURL.path
...
extension Notification.Name {
    static let fluffbuzzSelectSettingsTab = Notification.Name("fluffbuzzSelectSettingsTab")
}
