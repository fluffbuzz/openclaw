...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "com.fluffbuzz", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        FluffBuzzPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        FluffBuzzPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
