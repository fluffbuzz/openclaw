...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = FluffBuzzConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = FluffBuzzConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = FluffBuzzConfigFile.loadDict()
            ...
            FluffBuzzConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/fluffbuzz"
        state.remoteCliPath = ""
        return state
    }
}
