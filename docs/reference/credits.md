...
FluffBuzz = FLUFF + TARDIS, because every space puppy needs a time and space machine.

## Credits

- **Peter Steinberger** ([@steipete](https://x.com/steipete)) - Creator, puppy whisperer
- **Mario Zechner** ([@badlogicc](https://x.com/badlogicgames)) - Pi creator, security pen tester
- **Clawd** - The space puppy who demanded a better name
...
MIT - Free as a puppy in the ocean.
