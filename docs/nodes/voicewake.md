...
FluffBuzz treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.fluffbuzz/settings/voicewake.json`

Shape:

```json
{ "triggers": ["fluffbuzz", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
