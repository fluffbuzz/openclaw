...
summary: Machine-checked security models for FluffBuzz’s highest-risk paths.
read_when:
...
This page tracks FluffBuzz’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that FluffBuzz enforces its
...
**What this is not (yet):** a proof that “FluffBuzz is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/fluffbuzz-formal-models](https://github.com/vignesh07/fluffbuzz-formal-models).
...
```bash
git clone https://github.com/vignesh07/fluffbuzz-formal-models
cd fluffbuzz-formal-models
