---
summary: "VPS hosting hub for FluffBuzz (Oracle/Fly/Hetzner/GCP/exe.dev)"
read_when:
...
- `FLUFFBUZZ_NO_RESPAWN=1` avoids extra startup overhead from a self-respawn path.
...
- Add service env for stable startup path:
  - `FLUFFBUZZ_NO_RESPAWN=1`
  - `NODE_COMPILE_CACHE=/var/tmp/fluffbuzz-compile-cache`
