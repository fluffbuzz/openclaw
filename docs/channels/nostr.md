...
read_when:
  - You want FluffBuzz to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables FluffBuzz to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`fluffbuzz onboard`) and `fluffbuzz channels add` list optional channel plugins.
...
```bash
fluffbuzz plugins install @fluffbuzz/nostr
```

Use a local checkout (dev workflows):

```bash
fluffbuzz plugins install --link <path-to-fluffbuzz>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "fluffbuzz",
        "displayName": "FluffBuzz",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "fluffbuzz@example.com",
        "lud16": "fluffbuzz@example.com"
      }
    }
  }
}
