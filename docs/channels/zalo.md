...
- Install via CLI: `fluffbuzz plugins install @fluffbuzz/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `fluffbuzz plugins install ./extensions/zalo`
   - From npm (if published): `fluffbuzz plugins install @fluffbuzz/zalo`
...
- Approve via:
  - `fluffbuzz pairing list zalo`
  - `fluffbuzz pairing approve zalo <CODE>`
...
- Example: `fluffbuzz message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `fluffbuzz channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `fluffbuzz logs --follow`
