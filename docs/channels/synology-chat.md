---
summary: "Synology Chat webhook setup and FluffBuzz config"
read_when:
  - Setting up Synology Chat with FluffBuzz
...
```bash
fluffbuzz plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your FluffBuzz gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in FluffBuzz.
...
- Pairing approvals work with:
  - `fluffbuzz pairing list synology-chat`
  - `fluffbuzz pairing approve synology-chat <CODE>`
...
```bash
fluffbuzz message send --channel synology-chat --target 123456 --text "Hello from FluffBuzz"
fluffbuzz message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
