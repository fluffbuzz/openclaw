...
FluffBuzz ships three update channels:
...
When you **explicitly** switch channels with `--channel`, FluffBuzz also aligns
the install method:
...
When you switch channels with `fluffbuzz update`, FluffBuzz also syncs plugin sources:
