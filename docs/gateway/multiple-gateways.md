---
summary: "Run multiple FluffBuzz Gateways on one host (isolation, ports, and profiles)"
read_when:
...
Profiles auto-scope `FLUFFBUZZ_STATE_DIR` + `FLUFFBUZZ_CONFIG_PATH` and suffix service names.
