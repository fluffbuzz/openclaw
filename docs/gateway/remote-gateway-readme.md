---
summary: "SSH tunnel setup for FluffBuzz.app connecting to a remote gateway"
...
<dict>
    <key>Label</key>
    <string>com.fluffbuzz.ssh-tunnel</string>
...
```bash
launchctl bootstrap gui/$UID ~/Library/LaunchAgents/com.fluffbuzz.ssh-tunnel.plist
```
...
```bash
launchctl kickstart -k gui/$UID/com.fluffbuzz.ssh-tunnel
```

**Stop the tunnel:**

```bash
launchctl bootout gui/$UID/com.fluffbuzz.ssh-tunnel
```
