...
- 生成的 Swift 模型：`apps/macos/Sources/FluffBuzzProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/fluffbuzz/fluffbuzz/main/dist/protocol.schema.json
