...
本指南总结了在 FluffBuzz 中开发 Pi 集成的合理工作流程。
...
状态存储在 FluffBuzz 状态目录下。默认为 `~/.fluffbuzz`。如果设置了 `FLUFFBUZZ_STATE_DIR`，则使用该目录。
...
- https://docs.fluffbuzz.com/testing
- https://docs.fluffbuzz.com/start/getting-started
