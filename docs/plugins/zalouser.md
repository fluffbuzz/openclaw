...
read_when:
  - You want Zalo Personal (unofficial) support in FluffBuzz
...
Zalo Personal support for FluffBuzz via a plugin, using native `zca-js` to automate a normal Zalo user account.
