---
summary: "Overview of FluffBuzz onboarding options and flows"
read_when:
...
FluffBuzz supports multiple onboarding paths depending on where the Gateway runs
...
- [`fluffbuzz onboard` command](/cli/onboard)

## macOS app onboarding

Use the FluffBuzz app when you want a fully guided setup on macOS. Docs:
