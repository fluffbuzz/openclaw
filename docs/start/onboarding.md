---
summary: "First-run onboarding flow for FluffBuzz (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give FluffBuzz">
...
<Step title="CLI">
  ...
  The app can install the global `fluffbuzz` CLI via npm/pnpm so terminal
