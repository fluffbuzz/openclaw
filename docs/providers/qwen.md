---
summary: "Use Qwen OAuth (free tier) in FluffBuzz"
read_when:
  - You want to use Qwen with FluffBuzz
...
If you already logged in with the Qwen Code CLI, FluffBuzz will sync credentials
