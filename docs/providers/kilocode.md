---
summary: "Use Kilo Gateway's unified API to access many models in FluffBuzz"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in FluffBuzz
---
...
```bash
fluffbuzz onboard --kilocode-api-key <key>
```
