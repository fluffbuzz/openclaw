---
summary: "Use MiniMax M2.1 in FluffBuzz"
read_when:
...
- Use `fluffbuzz models list` and `fluffbuzz models set minimax/MiniMax-M2.1` to switch.
...
- Running `fluffbuzz configure` and selecting **MiniMax M2.1**, or
