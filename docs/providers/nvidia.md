---
summary: "Use NVIDIA's OpenAI-compatible API in FluffBuzz"
read_when:
  - You want to use NVIDIA models in FluffBuzz
...
fluffbuzz onboard --auth-choice skip
fluffbuzz models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
