...
You can point FluffBuzz at the proxy as a custom OpenAI-compatible endpoint:
...
- [Anthropic provider](/providers/anthropic) - Native FluffBuzz integration with Claude setup-token or API keys
