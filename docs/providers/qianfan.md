---
summary: "Use Qianfan's unified API to access many models in FluffBuzz"
read_when:
...
3. FluffBuzz installed on your system
...
4. Copy the API key for use with FluffBuzz

## CLI setup

```bash
fluffbuzz onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [FluffBuzz Configuration](/gateway/configuration)
