---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with FluffBuzz"
read_when:
  - You want Xiaomi MiMo models in FluffBuzz
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). FluffBuzz uses
