...
# Output:
# - dist/FluffBuzz.app
# - dist/FluffBuzz-<version>.zip
# - dist/FluffBuzz-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-com.fluffbuzz.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/FluffBuzz.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/FluffBuzz-$VERSION.zip"
DMG="$ROOT_DIR/dist/FluffBuzz-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/FluffBuzz-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/FluffBuzz-$VERSION.dSYM.zip"
