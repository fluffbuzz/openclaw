...
TRASH
  ...
  send_skills_flow() {
    ...
    workspace_dir="$HOME/.fluffbuzz/workspace"
    config_path="$HOME/.fluffbuzz/fluffbuzz.json"
    sessions_dir="$HOME/.fluffbuzz/agents/main/sessions"
...
NODE
  ...
  run_case_reset() {
    ...
    # Seed a remote config to exercise reset path.
	    cat > "$HOME/.fluffbuzz/fluffbuzz.json" <<'"'"'JSON'"'"'
{
  "meta": {},
