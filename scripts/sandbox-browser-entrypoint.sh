...
export DISPLAY=:1
export HOME=/tmp/fluffbuzz-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${FLUFFBUZZ_BROWSER_CDP_PORT:-${FLUFFBOT_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${FLUFFBUZZ_BROWSER_CDP_SOURCE_RANGE:-${FLUFFBOT_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${FLUFFBUZZ_BROWSER_VNC_PORT:-${FLUFFBOT_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${FLUFFBUZZ_BROWSER_NOVNC_PORT:-${FLUFFBOT_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${FLUFFBUZZ_BROWSER_ENABLE_NOVNC:-${FLUFFBOT_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${FLUFFBUZZ_BROWSER_HEADLESS:-${FLUFFBOT_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${FLUFFBUZZ_BROWSER_NO_SANDBOX:-${FLUFFBOT_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${FLUFFBUZZ_BROWSER_NOVNC_PASSWORD:-${FLUFFBOT_BROWSER_NOVNC_PASSWORD:-}}"
DISABLE_GRAPHICS_FLAGS="${FLUFFBUZZ_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${FLUFFBUZZ_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${FLUFFBUZZ_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
