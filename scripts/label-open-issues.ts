...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "fluffbuzz", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for FluffBuzz. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("FluffBuzz Issue Label Audit");
