...
- Keep product names in English: FluffBuzz, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the FluffBuzz Gateway, use “Gateway 网关”.
