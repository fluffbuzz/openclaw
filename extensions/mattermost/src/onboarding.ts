import type { ChannelOnboardingAdapter, FluffBuzzConfig, WizardPrompter } from "fluffbuzz/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.fluffbuzz.com/channels/mattermost",
    ].join("\n"),
