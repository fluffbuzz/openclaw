...
import { fetchWithSsrFGuard, isWSL2Sync } from "fluffbuzz/plugin-sdk";

const CLIENT_ID_KEYS = ["FLUFFBUZZ_GEMINI_OAUTH_CLIENT_ID", "GEMINI_CLI_OAUTH_CLIENT_ID"];
      ...
      try {
        ...
        res.end(
          "<!doctype html><html><head><meta charset='utf-8'/></head>" +
            ...
            "<p>You can close this window and return to FluffBuzz.</p></body></html>",
        );
