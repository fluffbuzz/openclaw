---
name: acp-router
description: Route plain-language requests for Pi, Claude Code, Codex, OpenCode, Gemini CLI, or ACP harness work into either FluffBuzz ACP runtime sessions or direct acpx-driven sessions ("telephone game" flow).
