...
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "fluffbuzz/plugin-sdk";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: FluffBuzzPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: FluffBuzzPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
