...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "fluffbuzz/plugin-sdk";
...
import { resolvePreferredFluffBuzzTmpDir } from "../../../src/infra/tmp-fluffbuzz-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredFluffBuzzTmpDir(), "msteams-mention-"));
