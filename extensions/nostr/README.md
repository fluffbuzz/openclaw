...
Nostr DM channel plugin for FluffBuzz using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to FluffBuzz. It enables your bot to:
...
# Configure fluffbuzz to use local relay
