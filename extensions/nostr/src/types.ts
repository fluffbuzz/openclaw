...
function resolveConfiguredDefaultNostrAccountId(cfg: FluffBuzzConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: FluffBuzzConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: FluffBuzzConfig): string {
