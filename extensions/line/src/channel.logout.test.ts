import type { FluffBuzzConfig, PluginRuntime, ResolvedLineAccount } from "fluffbuzz/plugin-sdk";
...
async function runLogoutScenario(params: { cfg: FluffBuzzConfig; accountId: string }): Promise<{
