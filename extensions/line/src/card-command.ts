import type { LineChannelData, FluffBuzzPluginApi, ReplyPayload } from "fluffbuzz/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: FluffBuzzPluginApi): void {
  api.registerCommand({
    name: "card",
