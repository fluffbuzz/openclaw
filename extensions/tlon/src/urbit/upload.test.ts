...
vi.mock("fluffbuzz/plugin-sdk", async (importOriginal) => {
  const actual = await importOriginal<typeof import("fluffbuzz/plugin-sdk")>();
  return {
    ...actual,
...
describe("uploadImageFromUrl", () => {
  ...
  it("fetches image and calls uploadFile, returns uploaded URL", async () => {
    const { fetchWithSsrFGuard } = await import("fluffbuzz/plugin-sdk");
