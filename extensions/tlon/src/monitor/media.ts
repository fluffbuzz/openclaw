...
import { fetchWithSsrFGuard } from "fluffbuzz/plugin-sdk";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to FluffBuzz workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".fluffbuzz", "workspace", "media", "inbound");
 ...
 * Format matches FluffBuzz's expected attachment structure.
 */
