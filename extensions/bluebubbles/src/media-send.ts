...
import { resolveChannelMediaMaxBytes, type FluffBuzzConfig } from "fluffbuzz/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: FluffBuzzConfig; accountId?: string }): string[] {
