...
This directory contains the **BlueBubbles external channel plugin** for FluffBuzz.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `fluffbuzz/plugin-sdk` helpers.
