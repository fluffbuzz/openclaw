import type { FluffbotConfig, PluginRuntime, RuntimeEnv } from "fluffbuzz/plugin-sdk";
...
async function dispatchMessage(params: { cfg: FluffbotConfig; event: FeishuMessageEvent }) {
